...
public class SMPPTest {
	...
	*/
	static String propsFilePath = "conf\\client.properties";
	...
	*/
	...
	private void submitMulti() {
		...
		try {
			...
			if (asynchronous) {
				...
				System.out.println("Submit Multi response "
						+ response.debugString());
				messageId = response.getMessageId();
			}
		} catch (Exception e) {
	...
	private Address getAddress(String type, Address address,
			int maxAddressLength) throws WrongLengthOfStringException {
